...
public class ProdutoController {
	...
	public ResponseEntity<List<Produto>> getByProduto(@PathVariable String produto){
		return produtoRepository.ok(produtoRepository.findAllByProdutoContainingIgnoreCase(produto));
	}
	...
	//ATUALIZAR - UPDATE(SYSQL)
	@PutMapping
	public ResponseEntity<Produto> put(@Valid @RequestBody Produto produto){
		return (produtoRepository.existsById(produto.getById())
